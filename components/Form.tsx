...
function Form() {
   ...
   const handleCategory = async (e: FormEvent) => {
    e.preventDefault();
    try {
      window.location.href= `mailto:muneshmyke@gmail.com?subject=${newCategory.subject}&body=Hello,my name is ${newCategory.name}. ${newCategory.message} (${newCategory.email})`
