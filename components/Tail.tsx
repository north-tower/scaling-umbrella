...
function Tail() {
  ...
  <div className="mb-10 max-w-lg lg:mb-0 lg:pr-16 xl:pr-20">
    ...
    <div className="mb-5 text-white text-xl">As a business owner myself, I understand the 
  ...
  <div className="mr-10 mb-6 lg:mb-0">
    ...
    <div className="p-4">
      ...
      <h5 className="text-white text-xl">Whether youre a small business owner, a freelancer, or an accountant, our app is
  ...
  <div className="">
    ...
    <div className="p-4">
      ...
      <h5 className="text-white text-xl">Our commitment to excellence is reflected 
