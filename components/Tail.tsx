...
function Tail() {
  ...
  <div className="mb-10 max-w-lg lg:mb-0 lg:pr-16 xl:pr-20">
    ...
    <div className="mb-5 text-white text-xl">As a business owner myself, I understand the challenges of keeping track of expenses and income. That's why we created [Your App Name]—to provide a comprehensive, user-friendly platform that makes bookkeeping effortless and accurate," says [CEO's Name], CEO of [Your Company]. "Our goal is to empower businesses to manage their finances with confidence and ease.</div>
    <div className="">
  ...
  <div className="mr-10 mb-6 lg:mb-0">
    ...
    <div className="p-4">
      ...
      <h5 className="text-white text-xl">Whether you're a small business owner, a freelancer, or an accountant, our app is designed to simplify your financial management processes, giving you more time to focus on what you do best—growing your business.!</h5>
